...
export default function VendorComparisonPanel({ responses, proposalId, requirementsApproved = false, preparedResponseIds, returnTo = "/vendor-responses" }: { responses: VendorResponseItem[]; proposalId: string; requirementsApproved?: boolean; preparedResponseIds?: string[]; returnTo?: string }) {
