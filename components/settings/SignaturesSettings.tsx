const labelClass = "mb-2 flex items-center justify-between text-sm font-semibold text-[#8f98bf]";
const inputClass =
...
const SignaturesSettings = () => {
  return (
    <section className="rounded-md border border-[#d7dce3] bg-[#f7f8fa] px-5 py-6 md:px-8">
      <h2 className="text-3xl font-semibold leading-none text-[#0f1b57] md:text-[36px]">
        Signatures
      </h2>
      <p className="mt-2 text-base leading-tight text-[#1f2d5d] md:text-[33px]">
      ...
      <div className="mt-8 grid grid-cols-1 gap-x-9 gap-y-6 md:grid-cols-2">
        <div>
          ...
          <div className="relative">
            <select id="signatureType" defaultValue="Type" className={inputClass + " appearance-none pr-8"}>
              <option>Type</option>
