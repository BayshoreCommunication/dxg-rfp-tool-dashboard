  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex items-start justify-between">
        <div className={`shrink-0 p-2.5 rounded-xl ${iconBg} backdrop-blur-sm group-hover:scale-110 transition-transform duration-300 shadow-sm`}>
...
const statsData: StatMetric[] = [
  ...
  },
  {
    ...
    progress: 85,
    gradient:
      "bg-gradient-to-br from-cyan-500 via-sky-500 to-blue-500",
