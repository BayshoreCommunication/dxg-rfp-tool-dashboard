      ...
      <div className="relative z-10 w-full max-w-[560px] rounded-[2.5rem] bg-white/90 px-10 py-12 text-center shadow-[0_30px_60px_-20px_rgba(0,0,0,0.06),0_0_0_1px_rgba(255,255,255,0.4)] backdrop-blur-xl ring-1 ring-gray-100/30 sm:px-14 sm:py-16">
        ...
        <div className="mb-6 flex justify-center">
          <span className="flex h-20 w-20 items-center justify-center rounded-full bg-primary/10">
            <ServerCrash className="h-10 w-10 text-primary" strokeWidth={1.75} />
          </span>
        </div>
        ...
        <p className="mx-auto mb-10 max-w-sm text-[14px] font-medium leading-relaxed text-gray-400">
          ...
          temporary, so trying again often does the trick.
        </p>
        ...
        <div className="mb-6 grid gap-3 sm:grid-cols-2">
          <button
            ...
            className="cursor-pointer group flex items-center justify-center gap-2 rounded-2xl py-4 text-[15px] font-bold text-white shadow-[0_4px_20px_rgba(34,38,40,0.4)] transition-all hover:-translate-y-0.5 hover:shadow-[0_8px_32px_rgba(34,38,40,0.55)] active:translate-y-0"
        ...
        {digest && (
          <p className="text-[12px] font-medium text-gray-300">
            If this keeps happening, mention error reference{" "}
